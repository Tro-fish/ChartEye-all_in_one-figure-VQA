...
def main():
  ...
  parser.add_argument('--train-annotations', type=str, default = "/home/wani/Desktop/Corning_team3/dataset/scicap_data/dataset/train/mini_train.json", help='Path to the data file')
  parser.add_argument('--valid-annotations', type=str, default = "/home/wani/Desktop/Corning_team3/dataset/scicap_data/dataset/val/mini_validation.json", help='Path to the data file')
  parser.add_argument('--train-images', type=str, default='/home/wani/Desktop/Corning_team3/dataset/scicap_data/dataset/train/images', help='Path to the training images')
  parser.add_argument('--valid-images', type=str, default='/home/wani/Desktop/Corning_team3/dataset/scicap_data/dataset/val/images', help='Path to the validation images')

  parser.add_argument('--output-dir', type=str, default="/home/wani/Desktop/Corning_team3/models/UniChart/output_data", help='Path to the output directory for saving the checkpoints')
  parser.add_argument('--max-steps', type=int, default = 5000, help='Max number of iterations')
  ...
  parser.add_argument('--accumulate-grad-batches', type=int, default=16, help='accumulate grad batches')
  ...
  train_dataset = UniChartDataset(args.train_annotations, images_folder = args.train_images, processor = processor, max_length=args.max_length,
                              split="train", prompt_end_token="<s_answer>", task_prefix = "<summarize_chart>"
                              )

  val_dataset = UniChartDataset(args.valid_annotations, images_folder = args.valid_images, processor = processor, max_length=args.max_length,
  ...
  config = {"max_steps":args.max_steps,
            ...
            "num_training_samples_per_epoch": 26868,
            "lr":args.lr,
